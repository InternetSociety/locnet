...
async def get_site_text_by_lang(lang: str, repository: DataRepositoryDependency):
    try:
        ...
        logging.exception("Failed to load site text")
        raise HTTPException(status_code=500, detail="Failed to load site text")
...
async def get_defaults_data(repository: DataRepositoryDependency):
    try:
        ...
        logging.exception("Failed to load defaults")
...
async def get_characteristics(
    ...
    try:
        ...
        logging.exception("Failed to calculate characteristics")
        raise HTTPException(
            status_code=500,
            detail="Failed to calculate characteristics",
        )
...
async def get_country_bounds(iso_3: str, repository: DataRepositoryDependency):
    try:
        ...
        logging.exception("Failed to load country bounds")
        raise HTTPException(status_code=500, detail="Failed to load country bounds")
